...
const Nav = () => {
  ...
  return (
    <nav>
      <ul className="uppercase font-semibold pl-[60px] text-[#ffffff]  justify-center items-center text-[0.9rem] bg-[#0d0723e1] list-none lg:space-x-[150px] space-x-[60px] hidden lg:flex">
        <li>
          <Link
            to="about"
            spy={true}
